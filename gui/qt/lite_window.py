...
from electrum_dgb.util import get_resource_path as rsrc
...
import re
import time
from electrum_dgb.wallet import Wallet, WalletStorage
import webbrowser
...
from electrum_dgb.version import ELECTRUM_VERSION as electrum_version
from electrum_dgb.util import format_satoshis, age
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.address_input.setPlaceholderText(_("Enter a Digibyte address or contact"))
        ...
        self.setWindowTitle("DigiElectrum")
