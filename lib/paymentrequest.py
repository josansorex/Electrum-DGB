...
REQUEST_HEADERS = {'Accept': 'application/bitcoin-paymentrequest', 'User-Agent': 'DigiElectrum'}
ACK_HEADERS = {'Content-Type':'application/bitcoin-payment','Accept':'application/bitcoin-paymentack','User-Agent':'DigiElectrum'}
...
def load_certificates():
    try:
        ...
        print "ca-bundle.crt file should be placed in ~/.digielectrum/ca/ca-bundle.crt"
...
class PaymentRequest:
    ...
    def send_ack(self, raw_tx, refund_addr):
        ...
        paymnt.memo = "Paid using Electrum for Digibyte"
